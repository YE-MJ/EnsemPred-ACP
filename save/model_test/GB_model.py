...
def gb_ensemble(df1, df2, df3, df4, df5, df6, df7, name1, name2, name3, name4, name5, name6, name7):
    ...
    for df, name in zip(dataframes, names):
        ...
        weight_file_paths = [
                f"./selected/best_model_gb_{name}_fold_1.pkl",
                f"./selected/best_model_gb_{name}_fold_2.pkl",
                f"./selected/best_model_gb_{name}_fold_3.pkl",
                f"./selected/best_model_gb_{name}_fold_4.pkl",
                f"./selected/best_model_gb_{name}_fold_5.pkl"
        ]
